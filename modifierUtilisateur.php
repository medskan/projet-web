		...
		<form action="" method="POST">
            <table align="center">
				...
				<tr>
					...
					<td>
						<input type="text" name="nom_hotel" id="nom_hotel" maxlength="20" value = "<?php echo $user['nom_hotel']; ?>">
					</td>
				</tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="mode_paiement" name="mode_paiement" id="email" <?php echo $user['mode_paiement']; ?>>
                    </td>
                </tr>
                <tr>
