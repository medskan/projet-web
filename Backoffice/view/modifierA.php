...
{
	$total++;
	$req="select * from activ where id=".$_GET['id'];
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Gestion Categorie</h3>
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i>Modifier Categorie</h4>
              <hr>
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          
<form align="center" id="myForm" method="get" action="updateA.php">

<input type="hidden" value="<?php echo $id; ?>" name="id">
<tr><td><label> Nom du categorie </label></td>
...
<td><input type="text" value="<?php echo $description;?>" class="form-control" name="description" placeholder="Description" style="width:400px"> </td></tr>
	...
	<td>
<label for="photo">Choisissez la photo à insérer</label></td><td><input type="file" name="photo" enctype= "multipart/form-data" /> </td> </tr>
</table>
