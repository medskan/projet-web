...
{
  $req="insert INTO offre(name,price,photo,categ) values ('".$_POST['name']."','".$_POST['price']."','".$_POST['photo']."','".$_POST['categ']."')";
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Gestion Offre</h3>
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i>Ajouter  Offre</h4>
              <hr>
...
<label style="font-weight: bold"> Nom du offre </label> 
<input type="text" class="form-control" name="name" placeholder="Nom du offre" value="" onblur="verifReff(this)" style="width:500px"> </br>
<label style="font-weight: bold"> Prix </label>
<input type="number"  onblur="verifNB(this)" class="form-control" name="price" value="" placeholder="Prix en Dt" style="width:200px"><a style="font-weight: bold">Dt </a> </br>
<label style="font-weight: bold">Ajouter une photo</label>
<input type="file" class="form-control" name="photo" > </br>
<input type="submit" value="valider" name="valider" action="offre.php"> 
