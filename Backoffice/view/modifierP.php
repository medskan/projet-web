...
{
	$total++;
	$req="select * from offre where id=".$_GET['id'];
	$db=config::getConnexion();
	$result=$db->query($req);
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i>Modifier  Offre</h4>
              <hr>
...
<td><input type="text"  value="<?php echo $name;?>" class="form-control" name="name" placeholder="Nom du produit" style="width:400px"> </td></tr>
<tr><td><label> Prix </label></td>
<td><input type="number" value="<?php echo $price;?>" class="form-control" name="price" placeholder="Prix en Dt" style="width:400px"> </td></tr>
<tr><td><img src="img/<?php echo $photo;?>" width="100" height="100" /> </td>
