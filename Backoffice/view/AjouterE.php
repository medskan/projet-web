...
{
  $req="insert INTO event(name,description,photo,datecreation) values ('".$_POST['name']."','".$_POST['description']."','".$_POST['photo']."','".$_POST['datecreation']."')";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i>Ajouter  Event</h4>
              <hr>
            <form id="myForm" method="POST" onsubmit="return verifform(this)" > 

			

<label style="font-weight: bold"> Nom du Event </label> 
<input type="text" class="form-control" name="name" placeholder="Nom du Event" value="" onblur="verifReff(this)" style="width:500px"> </br>
