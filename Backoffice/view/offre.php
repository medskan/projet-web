...
{   
$req="delete from offre where id=".$_POST['id'];
...
echo('<td> <img src="img/'.$prod['photo'].'" width="100" height="100" /> </td>'); 
...
?>
				 ...
				 <h5  style="color: white; background-color: green; width: 200px;" align="center"> <?php echo('Total de offres:'.$total)?></h5>
<form method="get" action="ajouterP.php" >
   <button align="center" style="background-color: #0c6071; width: 300px" class="btn btn-primary btn-block" type="submit" > <a>  Ajouter un autre offres  </a> </button>
</form>
</br>
                  </div>
                </div>
