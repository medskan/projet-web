...
{
  $req="insert INTO activ(name,description,photo,datecreation) values ('".$_POST['name']."','".$_POST['description']."','".$_POST['photo']."','".$_POST['datecreation']."')";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i>Ajouter  Activité</h4>
              <hr>
            <form id="myForm" method="POST" onsubmit="return verifform(this)" > 

				<label style="font-weight: bold"> Activité </label> 
...
<input type="submit" value="valider" name="valider" action="event.php"> 
